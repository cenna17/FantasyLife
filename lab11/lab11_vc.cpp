...
//  Dot product double 
double dot_double_vc(const double* arr1, const double* arr2, size_t length) {
    /*
    /*
    ...
    */
    ...
    for (size_t i = 0; i < length; i += 4) { //see class notes
...
//  Dot product float 
float dot_single_vc(const float* arr1, const float* arr2, size_t length) { //Basically same as above but denote to use floats 
